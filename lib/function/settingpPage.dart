...
class _SettingsPage2State extends State<SettingsPage2> {
  // final SoundNotification _soundNotification = SoundNotification();
  bool _isDark = false;
  @override
              ...
              children: [
                _SingleSection(
                  ...
                  children: [
                    ...
                    // GestureDetector(
                    //   onTap: () {
                    //     _soundNotification.playSound('piece');
                    //   },
                    //   child: Text('Sound'),
                    // ),
                  ],
...
//       prefix: 'assets/sounds/piece'); // Place your sound files in 'assets/
//   // sounds/'
//
//   Future<void> playSound(String soundFileName) async {
//     try {
//       await _audioCache.load('$soundFileName.mp3');
//     } catch (e) {
